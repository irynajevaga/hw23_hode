...
function delay(ms) {
    return new Promise(function (resolve) { return setTimeout(function () { return resolve("Completed after ".concat(ms, " ms")); }, ms); });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    promise1 = delay(1000);
                    promise2 = delay(2000);
                    promise3 = new Promise(function (_, reject) { return setTimeout(function () { return reject('Error in Promise 3'); }, 1500); });
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
            ...
            switch (_a.label) {
                case 0:
                    promises = numbers.map(function (num) {
                        return new Promise(function (resolve) { return setTimeout(function () { return resolve("Resolved after ".concat(num, " ms")); }, num); });
                    });
                    return [4 /*yield*/, Promise.all(promises)];
                case 1:
                    results = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    console.log("\nЗадание 2:");
                    return [4 /*yield*/, processStrings(["hello", "world", "typescript"])];
                case 2:
